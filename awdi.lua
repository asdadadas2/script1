...
function MakeScriptHub()
    print("CorrectKey")
    local OrionLib = loadstring(game:HttpGet(('https://raw.githubusercontent.com/shlexware/Orion/main/source')))()
local Window = OrionLib:MakeWindow({Name = "Nigga Hub | Universal Aimbot/Esp Script ", HidePremium = false, SaveConfig = true, ConfigFolder = "OrionTest"})
 ...
 OrionLib:MakeNotification({
	Name = "Reminder!",
	Content = "Thanks For Using This Script Made by Hecker",
...
OrionLib:MakeNotification({
	Name = "Reminder!",
	Content = "THIS MIGHT NOT WORK ON SOME GAMES!",
	Image = "rbxassetid://4483345998",
	Time = 15
})
